/*
A module to convert markdown files into .adoc equivalents. The current directory where this script is run will determine where the .md files are harvested from.
...
The /Users/jimnorthrop/Dropbox/Projects/gpars.github.io/FindMD.groovy test script only prints the name of any .md file with codehaus in it.

/Users/jimnorthrop/Dropbox/Projects/gpars.github.io/FindHTML.groovy  finds any .html files in it's 'path' variable and 
harvests each href and prints that out. Change var.value to parse different folders, guide,quick-start,etc.

Also see MissingURLSList.txt for full text of same.
*/
