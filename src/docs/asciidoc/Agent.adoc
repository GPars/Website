...
For latest update, see link:./core/Agent.html[the Agent section] or the link:./quickstart/index.html[Agent Quick Reference] plus the respective link:Demos.html[Demos].
